...
const ROWS: Record<Tab, Array<{ key: string; label: string; indent?: boolean }>> = {
  balance: [
    ...
    { key: 'accountsReceivables',       label: 'Receivables', indent: true },
    { key: 'inventory',                 label: 'Inventory', indent: true },
    { key: 'total_current_assets',      label: 'Total Current Assets' },
    { key: 'property_plant_equipment_net', label: 'PP&E (net)' },
  ...
  income: [
    ...
    { key: 'selling_general_and_administrative_expenses', label: 'SG&A', indent: true },
